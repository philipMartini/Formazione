...
@WebServlet(
		description = "A simple servlete example", 
		urlPatterns = { "/SimpleServletPath" },
...
public class SimpleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//In questo caso lo scope di Context rende disponibili delle infomrmazioni  
		//tra più richieste => condiviso fra piu servlets e utenti => COntext Object.
		//Un Context per webApp
	...
	/*
	 * Il metodo init() viene invocato SOLO una volta alla prima chiamata che la servlet riceve, ossia alla c
	 * creazione dell'oggetto.
	 * Per ogni richiesta viene invece invocato il metodo service() che si occupa di chiamare il corretto
	 * metodo doGet(), doPost()....
	 * 
	 * */

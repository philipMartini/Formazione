 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://service.filippo.advancia.org/", wsdlLocation = "http://localhost:8080/myFirstWebService/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://service.filippo.advancia.org/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/myFirstWebService/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://service.filippo.advancia.org/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.filippo.advancia.org/", "HelloPort"), Hello.class, features);
    }
